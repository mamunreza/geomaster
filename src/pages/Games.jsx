  ...
  return (
    <div className="page">
      <div className="container">
        <h1 style={{ fontSize: '1.4rem', fontWeight: 800, marginBottom: '0.35rem' }}>{t('nav.games')}</h1>
        <p style={{ color: 'var(--text-muted)', marginBottom: '1.5rem', fontSize: '0.9rem' }}>Choose your challenge and test your geography knowledge</p>
